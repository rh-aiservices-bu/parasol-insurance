...
If you have any feedback regarding this {ic}, please use https://github.com/TroyNelson11/parasol-insurance/issues[Issues,window=_blank] and https://github.com/TroyNelson11/parasol-insurance/pulls[Pull Requests,window=_blank].
