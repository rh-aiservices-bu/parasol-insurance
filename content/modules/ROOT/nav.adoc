...
** xref:05-02-web-app-deploy-application.adoc[5.2 Deploying the application via GitOps]
** xref:05-03-web-app-validating.adoc[5.3 Validating the application]
** xref:05-04-process-claims.adoc[5.4 Process claims with a pipeline]
